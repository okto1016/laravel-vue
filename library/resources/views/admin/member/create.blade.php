                ...
                <div class="card-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="gender" class="form-control" placeholder="Enter Gender" value=""
                                required="">
                            <th class="text-center">Phone Number</th>
                            <input type="text" name="phone_number" class="form-control" placeholder="Enter Number" value=""
                                required="">
